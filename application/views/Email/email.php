                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Verifikasi Email Anda <!-- <span style="color: #5caad2;">fashion</span> -->
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            Terima kasih telah melakukan pendaftaran akun di Portal Kerja Angkasa Pura Solusi Integra
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Untuk dapat menikmati fitur-fitur pada portal tersebut silakan klik tombol "Verifikasi Sekarang" di bawah untuk memverifikasi alamat email akun Anda.     
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                           <b>Setelah itu,</b> loginlah dengan alamat email dan password Anda, lalu lengkapilah seluruh data yang diperlukan pada portal ini dan nikmati fitur yang disediakan.   
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="<?php echo base_url() ?>Auth/ver_email/<?php echo $token ?>" style="color: #ffffff; text-decoration: none;">Verifikasi Sekarang</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <p style="line-height: 24px;margin-top: 20px">
                                            ...
                                            PT Angkasa Pura Solusi Integra <br><br>
                                            Area Perkantoran Terminal 1A Keberangkatan Bandara Internasional Soekarno Hatta , Tangerang Banten 19120 <br>
                                            
                                        </p>
                                        <a href="​www.apsintegra.co.id">​www.apsintegra.co.id</a>
                                    ...
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <!-- logo -->
                                                <td align="left">
                                                    <!-- <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="150" border="0" style="display: block; width: 200px;" src="https://integraaps.apsintegra.co.id/wp-content/uploads/2020/03/APSI-copy.png" alt="" /></a> -->
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">info@apsintegra.co.id</a>
