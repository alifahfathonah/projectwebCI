      ...
      <div class="container">
        ...
        <div class="row col-md-12" style="margin-top: 5%">
         ...
         <!--  <div class="col-md-4 ftco-animate">
          ...
          <div class="col-lg-4 col-md-6 ftco-animate" data-aos="fade-up">
              <div class="card h-100" style="width: 20rem;">
                ...
                <div class="card-body">
                  ...
                  <span class="sub-title d-block mb-1" style="font-size: 20px; font-color: blue "><?php echo $d->name ?></span>
                  <p class="card-text">
                    <p style="font-color: grey"><i class="fas fa-map-marker-alt"></i> <?php echo $d->name_regencies ?></p>
                    <p style="font-color: grey"><i class="fas fa-briefcase"></i> <?php echo $d->name_category ?></p>
                    <p style="margin-top: -15px"><i class="fas fa-graduation-cap"></i> <?php echo $d->education ?></p>
                    <p style="margin-top: -15px"><i class="fas fa-comment-dollar"></i> <?php echo $d->salary ?></a></p>
                    <p style="margin-top: -15px">Closing Date <?php echo $d->closing_date ?></a></p>
                  ...
                  <a href="<?php echo base_url(); ?>Landing/get_vacancy_by_id/<?php echo $d->id_vacancy ?>"  class="btn btn-primary">Selengkapnya</a>
                </div>
              </div>
            </div>
              <?php   }
